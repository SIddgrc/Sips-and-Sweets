...
$sql = "SELECT id, name, contact, address, company_name, bday, gender FROM mkt";
...
<body>
    ...
    while ($row = $result->fetch_assoc()) {
            ...
            echo "<p><strong>Contact Number/Email:</strong>" . $row["contact"] . "</p>";
            echo "<p><strong>Address:</strong>" . $row["address"] . "</p>";
            echo "<p><strong>Company name:</strong>" . $row["company_name"] . "</p>";
            echo "<p><strong>Birthday:</strong>" . $row["bday"] . "</p>";
            echo "<p><strong>Gender:</strong>" . $row["gender"] . "</p>";
// Edit button
      echo "<a href='sas_mkt_edit.php?id=" . $row["id"] . "' class='form-button'>Edit</a>";

      echo " ";
      // Delete button
      echo "<a href='sas_mkt_delete.php?id=" . $row["id"] . "' class='form-button'>Delete</a>";
  ...
  <a href="sas_mkt.html" class="form-button">New Entry</a>
</body>
</html>
